...
As shown in the example above, `Reduce` combines the first element of a vector with the second element of a vector, then that combined result is combined with the third element of the vector, and so on until the end of the vector is reached. Setting `accumulate = FALSE` only returns the final result.
